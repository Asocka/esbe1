...
cl = LineClient(authToken='EG3kxdiojvP1ikiTaa7e.mDIRQD+WthuKlYOGL7ITRG.HHoZX4QMq+hHxeok6Kq6ybr6X6ipexRCjXByAki1Dn8=')
...
wait = {
    ...
    "unsend":False,
    "mention":"heh.......ngintip terus\nawas mata nya bintitan segede biji salak.?",
    "Respontag":"tag sekali lagi dapat gelas.",
    "welcome":"Assalamualaikum \nselamat datang.\njangan lupa cek NOTE.\noh iya saLken ya.",
    "leave":"Selamat tinggal sahabat\nsmoga kamu tenang disana ya...",
    "comment":"mau comment apa ya..???",
    "message":"Terimɑ Kɑsih sudah menambahkan saya sebagai teman./nJangan lupa kepoin TL ku ya..wkwk",
}
read = {
    "readPoint":{},
    "readMember":{},
...
def leaveMembers(to, mid):
    try:
        arrData = ""
        textx = "「 Ada yang baper 」\nInalillahi wainalillahi rojiun ".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
...
def help1():
    ...
    helpMessage1 =" ᴋᴇʏᴡᴏʀᴅ\n" + \
                  ...
                  "🔱 " + key + "ʙᴏᴛ\n" + \
                  "🔱 " + key + "ǫᴜᴏᴛᴇs\n" + \
                  "🔱 " + key + "ᴀᴅᴍɪɴᴀᴅᴅ @\ᴀᴅᴍɪɴᴅᴇʟʟ @\n" + \
                  "🔱 " + key + "sᴛᴀғғᴀᴅᴅ @\sᴛᴀғғᴅᴇʟʟ @「ɴᴏᴍᴇʀ」\n" + \
                  "🔱 " + key + "ʙᴏᴛ:ᴏɴ/ᴏғғ\n" + \
                  "🔱 " + key + "ʀᴇғʀᴇsʜ\n" + \
                  "🔱 " + key + "ʙᴏᴛʀᴇғᴇᴀᴛ @\n" + \
                  "🔱 " + key + "Promo\n" + \
                  ...
                  "📵 ʏᴏ'ʀᴇ ᴅᴇᴠɪᴄᴇ: line://nv/connectedDevices \n" + \
                  "🕵 ᴄʀᴇᴀᴛᴇᴅ: line.me/ti/p/~ketikidmu111"
    ...
    try:
            ...
            if mid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        cl.sendMessage(op.param1,"kok " +str(ginfo.name))
                    else:
                        cl.acceptGroupInvitation(op.param1)
                        ginfo = cl.getGroup(op.param1)
                        cl.sendMessage(op.param1,"kok " + str(ginfo.name))
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  sendMention(op.param1, op.param1, "Hai ", ", terimakasih sudah menambahkan saya sebagai teman.")
                  cl.sendText(op.param1, wait["message"])
                  cl.sendContact(op.param1, "u07abdfb9d1644326c65c13f9727b10d7")
                ...
                try:
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'ɢᴀᴍʙᴀʀ ᴅɪ ʙᴀᴡᴀʜ':
                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           cl.sendMessage(msg.to, None, contentMetadata={"STKID":"16867956","STKPKGID":"8676","STKVER":"3"}, contentType=7)
                           cl.sendMessage(msg.to, wait["Respontag"])
                           cl.sendImageWithURL(msg.to,image)
                           rnd = ["dimana-mana ditag bot terus."]
                           p = random.choice(rnd)
                           lang = 'id'
               ...
               if 'MENTION' in msg.contentMetadata.keys() != None:
                if msg._from not in Bots:
                 if wait["mentionKick"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in admin:
                           cl.sendMessage(msg.to, "masih suka ngetag aja\ntendang juga nich")
                           ...
                           if targets == []:
                               ...
                               for target in targets:
                                   try:
                                       ...
                                       cl.createGroup("ᴀᴄᴄ ʀᴏᴏᴍ ʙᴇʀ-ᴀᴄ",[target]) 
                                       cl.createGroup("ᴀᴄᴄ ʀᴏᴏᴍ ʙᴇʀ-ᴀᴄ",[target]) 
                                       cl.createGroup("ᴀᴄᴄ ʀᴏᴏᴍ ʙᴇʀ-ᴀᴄ",[target])
                                       cl.sendText(send,"Berhasil Invite " + korban + "\ntry later....")
                  ...
                  if wait["invite"] == True:
                    ...
                    for s in groups.members:
                        if invite in wait["blacklist"]:
                            cl.sendMessage(msg.to, "「Akun berada dalam daftar blacklist...」")
                            break
                        else:
                            targets.append(invite)
                    if targets == []:
                        pass
                         ...
                         for target in targets:
                             try:
                                  ...
                                  cl.sendText(msg.to,"maaf ,status akun saat ini sedang limit silahkan coba lagi nanti atau manual.")
                                  wait["invite"] = False
                                  break
#ADD Bots
               if msg.contentType == 13:
               ...
               if msg.contentType == 0:
                 ...
                 if text is None:
                     return
                        ...
                        elif cmd == "creator" or text.lower() == 'creat':
                            if msg._from in admin:
                           ...
                           if msg._from in admin:
                             if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                    ...
                                    cl.sendMessage(msg.to, "Masuk ke : %s" % str(group.name))
...
#                                ret_ += "\n╚══[ Total {} Spam call]".format(str(dan[1]))
                                cl.sendMessage(msg.to, "Berhasil memanggil ")
...
#===========BOT UPDATE============#
                        elif msg.text in ["tag","Tagall","tagall","unch","hai","hei","heh","all","kumpul","Nah","hadir"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.sendText(msg.to, "Bye bye semuanya yg ada di "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if wait["selfbot"] == True:
                                if msg._from in admin:
                                    ...
                                    cl.sendText(msg.to,
                                                "Lurking berhasil dinonaktifkan\n\nTanggal : " + datetime.strftime(
                            ...
                            if msg._from in admin:
                                if msg.to in Setmain['ARreadPoint']:
                                    ...
                                    cl.sendText(msg.to, "Ketik lurk on dulu")
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if msg._from in admin:
                             cl.sendMessage(msg.to,"Hal yg sangat menyedihkan ketika melihat seseorang yang ditinggal pas lagi sayang2nya..ada???")
                             msg.contentType = 13
                             msg.contentMetadata = {'mid': admin}
                             tanya = msg.text.replace("quotes ","")
                             jawab = ("semua tak kan terhenti disini.")
                             jawaban = random.choice(jawab)
                             tts = gTTS(text=jawaban, lang='id')
                             tts.save('tts.mp3')
                             cl.sendAudio(msg.to,'tts.mp3')
                             cl.sendMessage(msg)         
                             cl.sendMessage(msg.to,"Jika galau berlanjut silahkan konsultasi mamah dedeh jangan ke dr.Boyke")

                        elif cmd == "intro":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               cl.sendContact(to, mid)
                               cl.sendMessage(msg.to, "http://line.me/ti/p/~ketikidmu111")
                               cl.sendMessage(msg.to, None, contentMetadata={"STKID":"13973165","STKPKGID":"1351366","STKVER":"1"}, contentType=7)

                        elif cmd == "bot" or cmd == "mbut":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "ᴊᴇᴍʙᴏᴛ")
                               elapsed_time = time.time() - start
                               cl.sendMessage(msg.to, "ᴅᴏɴ'ᴛ ᴄᴀʟʟ ᴍᴇ".format(str(elapsed_time)))

                        elif cmd == "list":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "╭═══════════\n║─[    DAFTAR HARGA    ]─ \n║SELFBOT ONLY = 50K /BLN\n║2 ASSIST = 75K /BLN\n║5 ASSIST = 150K /BLN\n║10 ASSIST = 250K /BLN\n║\n║PROTECT ANTIJS\n║\n║2 BOT + ANTIJS = 125K /BLN\n║5 BOT + ANTIJS = 275K /BLN\n║10 BOT + ANTIJS = 425K /BLN\n║\n║══UNTUK SEMENTARA OFF\n║ INFO CONTACT DIBAWAH INI   \n║\n║http://line.me/ti/p/~ketikidmu111\n║       ARIGATO      \n║\n╰════════════")
                               cl.sendMessage(msg.to, "Dibaca baik-baik. ")
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = True
                                cl.sendText(msg.to,"「 Status Autoblock 」\nAutoblock telah diaktifkan")
