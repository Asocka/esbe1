...
cl = LineClient(authToken="EB1thbAtdpGcIhnCpO9f.7ejwPz7hhPjfA23WJ1YOZW.juGG+XOn3cKqrRKcKcUtB7wBtNz8Pap/xGZnfL3W9v8=")
...
wait = {
    ...
    "unsend":True,
    "mention":"كيف يمكن لي ان اساعدك ؟..",
    "Respontag":"عيوني الفوشية👀 ",
    "welcome":"اهلا بك في قروب نجوم المايك كل شيء يرحب بك كل شيء يتبسم ويتوهج فرحاً بقدومك \namin",
    "leave":"نراك قريبا اخي اختي....",
    "comment":"......",
    "message":"......",
}
read = {
            ...
            if msg.toType == 2:
               ...
               if msg.contentType == 16:
                    if wait["Timeline"] == True:
                            ret_ = "「 لا يستطيع أحد ركوب ظهرك إلّا إذا كنت منحنياً 」"
                            if msg.contentMetadata["serviceType"] == "GB":
                                contact = cl.getContact(sender)
                                auth = "".format(str(contact.displayName))
                            else:
                                auth = "قروب : {}".format(str(msg.contentMetadata["serviceName"]))
                            ret_ += auth
               ...
               if msg.contentType == 0:
                 ...
                 if text is None:
                     return
                        ...
                        elif cmd == "me" or text.lower() == 'انا':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 .:(الحساب الاساسي):. 」\n", "")
                               msg.contentType = 13
...
#                                wait["myProfile"]["coverId"] = str(coverId)
                        ...
                        elif msg.text in ["Kalender","Time","Waktu","الوقت الان"]:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 اعادة ضبط المصنع 」\nUser ", "\n\n\n\nٍجري اعادة ضبط المصنع [❗] ")
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectqr:
                                       msgs = "الحماية: تعمل بشكل جيد [🔓]"
                                  else:
                                       protectqr.append(msg.to)
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "الحماية : 「 ✅ 」\n \n  Group [🔓] : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "الحماية: تعمل الان ⚔️ \n[🛡]\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectqr:
                                         ...
                                         msgs = "ألحماية مقفلة فعلا [🔒]"
                                    cl.sendMessage(msg.to, "الحماية: مقفلة الان❗❗❗...\n[🛡]\n" + msgs)
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"❕..إرسال جهة الاتصال إلى المجموعة")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["unsend"] = True
                                sendMention(msg.to, sender, "「 📡اعادة ارسال المحذوف📡 」\nتعمل الان  ", "\يتم الان الكشف عن الهدف ...")

                        elif cmd == "unsend off" or text.lower() == 'unsend off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["unsend"] = False
                                sendMention(msg.to, sender, "「 📡اعادة ارسال المحذوف📡 」\nتعمل الان  ", " \nيتم الان الكشف عن الهدف ...")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendText(msg.to,"「 ✅  الرد التلقائي  ✖️ 」\n \n  \n \nتم تفعيل الرد التلقائي [✅] ")

                        elif cmd == "respon off" or text.lower() == 'respon off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = False
                                cl.sendText(msg.to,"「 ✅  الرد التلقائي  ✖️ 」\n \n \n \nتم تعطيل الرد التلقائي[✖️] ")

                        elif cmd == "autojoin on" or text.lower() == 'autojoin on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = True
                                cl.sendText(msg.to,"「 ✅  الدخول المباشر  ✖️ 」\n \n  \n \nتم تفعيل الدخول المابشر [✅] ")

                        elif cmd == "autojoin off" or text.lower() == 'autojoin off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = False
                                cl.sendText(msg.to,"「 ✅  الدخول المباشر  ✖️ 」\n \n \n \nتم تعطيل الدخول المباشر[✖️] ")

                        elif cmd == "autoleave on" or text.lower() == 'autoleave on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = True
                                cl.sendText(msg.to,"「 ✅  الخروج المباشر  ✖️ 」\n \n  \n \nتم تفعيل الخروج المباشر [✅] ")

                        elif cmd == "autoleave off" or text.lower() == 'autoleave off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = False
                                cl.sendText(msg.to,"「 ✅  الخروج المباشر  ✖️ 」\n \n \n \nتم تعطيل الخروج المباشر[✖️] ")

                        elif cmd == "autoblock on" or text.lower() == 'autoblock on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = True
                                cl.sendText(msg.to,"「 ✅  الحظر المباشر  ✖️ 」\n \n  \n \nتم تفعيل الحظر المباشر [✅] ")

                        elif cmd == "autoblock off" or text.lower() == 'autoblock off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoBlock"] = False
                                cl.sendText(msg.to,"「 ✅  الحظر المباشر  ✖️ 」\n \n \n \nتم تعطيل الحظر المباشر[✖️] ")

                        elif cmd == "autoadd on" or text.lower() == 'autoadd on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = True
                                cl.sendText(msg.to,"「 ✅  الاضافة المباشرة  ✖️ 」\n \n  \n \nتم تفعيل الاضافة المباشرة [✅] ")

                        elif cmd == "autoadd off" or text.lower() == 'autoadd off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = False
                                cl.sendText(msg.to,"「 ✅  الاضافة المباشرة  ✖️ 」\n \n \n \nتم تعطيل الاضافة المباشرة[✖️] ")
