...
cl = LineClient(authToken="u6094f30902a333ed9c50bccc9d623379:aWF0OiAxNTUwNDc4MDY4NDQzCg==..w3kqiYByrm6+6Modu9RWtD0b/ps=",appName = "IOS\t8.14.5\tnoobcoder\t7.0.0")
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken="uf5e720a0bbc18a718bdaf73571929dd7:aWF0OiAxNTUwNDc3OTg3OTA3Cg==..t+CyZrWwcB8ZjhG1CrV9EmOYq10=",appName = "IOS\t8.14.5\tnoobcoder\t7.0.0")
ki.log("Auth Token : " + str(ki.authToken))
ki.log("Channel Access Token : " + str(channel.channelAccessToken))

kk = LineClient(authToken="u260f3325f78464333aa93c666b6342c8:aWF0OiAxNTUwNDc3OTA3OTkwCg==..HSfVSE1fNmKNEAjnbrzFZVk0HVw=",appName = "IOS\t8.14.5\tnoobcoder\t7.0.0")
kk.log("Auth Token : " + str(kk.authToken))
kk.log("Channel Access Token : " + str(channel.channelAccessToken))

kc = LineClient(authToken="u4b6ca4ca14ee94ab02f9d1f3c191322d:aWF0OiAxNTUwNDc3Nzk3NzI1Cg==..yfQVjxfsLehN6V0ulhb5TiivFZU=",appName = "IOS\t8.14.5\tnoobcoder\t7.0.0")
kc.log("Auth Token : " + str(kc.authToken))
kc.log("Channel Access Token : " + str(channel.channelAccessToken))

kb = LineClient(authToken="u15fe79e1449b54824efc3a7e589cf1dc:aWF0OiAxNTUwNDc3NzA2NzgzCg==..hNmM58EpDXk0AQ+ajCIIfWGuLgI=",appName = "IOS\t8.14.5\tnoobcoder\t7.0.0")
kb.log("Auth Token : " + str(kb.authToken))
kb.log("Channel Access Token : " + str(channel.channelAccessToken))

kd = LineClient(authToken="u754e7ab8f77b8a1674b859f80e6c714a:aWF0OiAxNTUwNDc3NjYwNTQ2Cg==..qZ0DhlFLJzr9gejmPmNy3lRmTnM=",appName = "IOS\t8.14.5\tnoobcoder\t7.0.0")
kd.log("Auth Token : " + str(kd.authToken))
kd.log("Channel Access Token : " + str(channel.channelAccessToken))

ke = LineClient(authToken="u7f9eb610095ff7c188e450156055387d:aWF0OiAxNTUwNDc3NzYwMzUxCg==..PMku2VgVSykKna7czk324PyI8j0=",appName = "IOS\t8.14.5\tnoobcoder\t7.0.0")
ke.log("Auth Token : " + str(ke.authToken))
ke.log("Channel Access Token : " + str(channel.channelAccessToken))

kf = LineClient(authToken="u5ed7047c1ceb92a2a5074091ceb33cf1:aWF0OiAxNTUwNDc3ODM5MzYzCg==..5SOMZ4vuAhsCxFkSMHD1J2Uaj+Q=",appName = "IOS\t8.14.5\tnoobcoder\t7.0.0")
kf.log("Auth Token : " + str(kf.authToken))
kf.log("Channel Access Token : " + str(channel.channelAccessToken))

kj = LineClient(authToken="u2e75f0c7d685e9d282a02dc7abf42cd2:aWF0OiAxNTUwNDc3OTQzODQ4Cg==..a6EbtBhXBt1+Z0ykB+NISaDA5ME=",appName = "IOS\t8.14.5\tnoobcoder\t7.0.0")
kj.log("Auth Token : " + str(kj.authToken))
kj.log("Channel Access Token : " + str(channel.channelAccessToken))

sw = LineClient(authToken="u33e2ecbfe9ec030688b86fa587436ca6:aWF0OiAxNTQ3NjkzNjI3NzA5Cg==..xTzEDoVrFnfKzEC8X4XSpoCtBqg=",appName = "IOS\t8.14.5\tnoobcoder\t7.0.0")
...
poll = LinePoll(cl)
call = cl
creator = ["u91d5d161e0935121e6217c9bd93410f0","u09a7e4b7c9b160e5382a391805b20957","ue30f597601dbead84804c31fa8f10175","u879d9932fe5db568f9f129d219267c42"]
owner = ["u91d5d161e0935121e6217c9bd93410f0","u09a7e4b7c9b160e5382a391805b20957","ue30f597601dbead84804c31fa8f10175","u879d9932fe5db568f9f129d219267c42"]
admin = ["u91d5d161e0935121e6217c9bd93410f0","u09a7e4b7c9b160e5382a391805b20957","ue30f597601dbead84804c31fa8f10175","u879d9932fe5db568f9f129d219267c42"]
staff = ["u91d5d161e0935121e6217c9bd93410f0","u09a7e4b7c9b160e5382a391805b20957","ue30f597601dbead84804c31fa8f10175","u879d9932fe5db568f9f129d219267c42","u3fd2124cfdb2f39c3f6999f754689ffc","uaafc698a41c3d0d0b3e3b2bf36f40768","u7f1121d59417d5c5f917002979970bfc","ue5172937516330a749060dae586f5ef9","u07b8ed80d526a5aac07b70a30a3cf784","uf95b0822d52e52509dff5b00279cd49f","uc5842b2f65a7ee318c1ef4ec58362c87","uec4256a59ec71e92456b6df08f5ca8cf","u91d5d161e0935121e6217c9bd93410f0"]
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendText("ue30f597601dbead84804c31fa8f10175", '.')
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                Ticket = cl.reissueGroupTicket(msg.to)
                                ki.acceptGroupInvitationByTicket(msg.to,Ticket)
                                ki.sendMessage(msg.to, "Welcome "+str(G.name))
                                kk.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kk.sendMessage(msg.to, "Welcome "+str(G.name))
                                kc.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kc.sendMessage(msg.to, "Welcome "+str(G.name))
                                kb.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kb.sendMessage(msg.to, "Welcome "+str(G.name))
                                kd.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kd.sendMessage(msg.to, "Welcome "+str(G.name))
                                ke.acceptGroupInvitationByTicket(msg.to,Ticket)
                                ke.sendMessage(msg.to, "Welcome "+str(G.name))
                                kf.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kf.sendMessage(msg.to, "Welcome "+str(G.name))
                                G = cl.getGroup(msg.to)
                                G.preventedJoinByTicket = True
                                cl.updateGroup(G)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectinvite:
                                       msgs = "➲ Protect invite Already ON [✅]"
                                  else:
                                       protectinvite.append(msg.to)
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "Status : [ ✅ ]\nDi Group : " +str(ginfo.name)
                                  cl.sendMessage(msg.to, "「 ➲〘 PROTECT INVITE 〙➲  」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectinvite:
                                         ...
                                         msgs = "➲ Protect invite Already OFF [❌]"
                                    cl.sendMessage(msg.to, "「 ➲〘 PROTECT INVITE 〙➲ 」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  ...
                                  if msg.to in protectcancel:
                                      ...
                                      msgs = "Status : [ ✅ ]\nDi Group : " +str(ginfo.name)
                                      msgs += "\n➲ All pro  Already ON [✅]"
                                  cl.sendMessage(msg.to, "「 ➲〘 PROTECT ALL 〙➲ 」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectqr:
                                         protectqr.remove(msg.to)
                                    else:
